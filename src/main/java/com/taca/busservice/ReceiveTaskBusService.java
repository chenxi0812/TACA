...
public class ReceiveTaskBusService {
    ...
    @Transactional
    public ResultBean receiveTask(Long id){
        ...
        receiveTask.setUserName("wuxiaofang663");
        ...
        receiveTask.setExpectedTime(DateUtil.getAfterDate(new Date(),taskInfo.getTimeLength().intValue()));
