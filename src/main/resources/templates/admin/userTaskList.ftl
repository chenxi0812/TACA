							...
							<table
								...
								<thead>
									<tr class="am-success">
										...
										<th class="table-type">TRANS_ID</th>
								...
								<tbody>
									...
									<tr>
										...
										<td class="am-hide-sm-only"><a
											href="taskInfo/${reciveTask.taskId}">${reciveTask.taskId}</a></td>
										<td class="am-hide-sm-only">${reciveTask.name}</td>
										...
										<td class="am-hide-sm-only">${reciveTask.transId}</td>
										 <#if
										reciveTask.startTime??>
										<td class="am-hide-sm-only	">${reciveTask.startTime?date}</td>
										<#else>
										<td></td> </#if>
										<td class="am-hide-sm-only">${reciveTask.status}</td>
									</tr>
									</#list>
