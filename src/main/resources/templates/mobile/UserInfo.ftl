        ...
        <div class="pet_grzx">
            ...
            <div class="pet_grzx_nr">
                <div class="pet_grzx_ico">
                    ...
                    <#else>
                        <img src="../../static/mobile/img/touxiang.jpg" onclick="javascript:upLoad()">
                    </#if>
                    </div>
                <div class="pet_grzx_name"><span id="nickName" data-am-modal="{target:'#my-prompt'}" onclick="javascript:reName(${userInfo.id?default(0)?c},'${userInfo.nickName}')">${userInfo.nickName}</span></div>
                <div class="pet_grzx_map">${userInfo.userName}</div>
                <div class="pet_grzx_num">
                    <span>${userInfo.historyStar}<i>累记星点</i></span>
