...
<body style="background:#ececec">
  <div class="pet_mian" >
    ...
    <div class="pet_content pet_content_list pet_hd">
              ...
              <ul class="am-list">
                ...
                <li class="am-g am-list-item-desced am-list-item-thumbed am-list-item-thumb-right pet_hd_list">
                  <a href="###" class="pet_hd_block">
                    <div class="pet_hd_block_title">Prize ON.${list_index+1}</div>
                    ...
                    <div class="pet_hd_block_tag">兑换状态<span class="hd_tag_jh">${list.status}</span> </div>
                  </a>
                </li>
                </ul>
            </#list>
     ...
     <a href="${base}/mobile/goods/list"><button class="pet_hd_con_gp_list_xl_m store">激励商店</button></a>
