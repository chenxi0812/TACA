...
<div class="pet_mian" id="top">
    ...
    <div class="pet_circle_nav">
        <ul class="pet_circle_nav_list">
            ...
            <li><a href="${base}/mobile/mygoods/wuxiaofang663" class="iconfont pet_nav_meirong ">&#xe629;</a><span>我的激励</span></li>
                    ...
                    <li class="am-g am-list-item-desced am-list-item-thumbed am-list-item-thumb-right pet_list_one_block">
                        <#list noticeList as noticeInfo >
                            <div class=" am-u-sm-8 am-list-main pet_list_one_nr">
                                <h3 class="am-list-item-hd pet_list_one_bt"><a href="${base}/mobile/notice/${noticeInfo.id}" class="">${noticeInfo.title}</a>
                                </h3>
                            ...
                            <div class="am-u-sm-4 am-list-thumb">
                                <img src="${base}/icon/show?iconAddress=${noticeInfo.iconAddress}" class="pet_list_one_img" alt=""/>
                            </div>
                        </#list>
                    </li>
                </ul>
