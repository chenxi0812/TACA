...
<div class="pet_mian">
    ...
    <div class="pet_content">
        <div class="pet_content_block">
            ...
            &nbsp;&nbsp;&nbsp;&nbsp;<button type="button" class="am-btn am-btn-primary" data-am-modal="{target: '#my-alert'}" onclick="javascript:exchangeGoods(${goodsInfo.id?default(0)?c},'${Session["username"]?default("session")}')">点击兑换
            </button>
            <br>
            <br>
        </div>
